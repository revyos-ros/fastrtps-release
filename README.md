...
The packages in the `fastrtps` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy fastrtps --override-release-repository-push-url git@github.com:revyos-ros/fastrtps-release.git` on `Thu, 19 Dec 2024 07:08:44 -0000`
...
- release repository: https://github.com/revyos-ros/fastrtps-release.git
...
The packages in the `fastrtps` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble fastrtps --override-release-repository-push-url git@github.com:revyos-ros/fastrtps-release.git` on `Sat, 14 Dec 2024 11:45:34 -0000`
...
## fastrtps (jazzy) - 2.14.1-2

The packages in the `fastrtps` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy fastrtps --override-release-repository-push-url git@github.com:revyos-ros/fastrtps-release.git` on `Thu, 13 Jun 2024 04:41:52 -0000`
